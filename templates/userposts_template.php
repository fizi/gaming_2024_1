...
$USERPOSTS_TEMPLATE['comments_table'] = "
    <tr class='border-bottom border-secondary text-white'>
	  <td>
		{USERPOSTS_COMMENTS_HREF_PRE}<b>{USERPOSTS_COMMENTS_HEADING}</b></a>
		<div class='small'>{USERPOSTS_COMMENTS_DATESTAMP} ({USERPOSTS_COMMENTS_TYPE})</div>
	  </td>
	</tr>
	<tr class='border-bottom border-secondary text-white'>
...
$USERPOSTS_TEMPLATE['forum_table'] = "
	  <tr class='border-bottom border-secondary text-white'>
	    <td>
		  ...
		  <div class='small'>({USERPOSTS_FORUM_NAME_HREF_PRE}<b>{USERPOSTS_FORUM_NAME}</b></a>)</div>
		  <div class='small text-white'>{USERPOSTS_FORUM_DATESTAMP}</div>
		</td>
	  </tr>
	  <tr class='border-bottom border-secondary text-white'>
		<td class='text-white-50'>
