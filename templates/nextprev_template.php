...
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] = '
    <li class="page-item"><a class="page-link prev" href="{url}" title="{url_label}"><i class="fas fa-angle-left"></i></a></li>
';
...
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] = '
    <li class="page-item"><a class="page-link next" href="{url}" title="{url_label}"><i class="fas fa-angle-right"></i></a></li>
';
