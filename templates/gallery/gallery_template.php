...
$GALLERY_TEMPLATE['list']['item'] = '
    <div class="col-md-4">
      <div class="gallery-item-box shadow">
		{GALLERY_THUMB: w=1000&h=700&actualPreview&class=gallery-item}
    ...
    <div class="col-md-6">
      <div class="gallery-cat-item-box shadow">
        <a class="gallery-cat-item" href="{GALLERY_CAT_URL}">
		  ...
		  <img src="{GALLERY_CAT_THUMB: thumbsrc}" />
        </a>
...
<!-- start portfolio -->
<div class="portfolio-header pt-2 pb-4"><span><a href="{GALLERY_BASEURL}">{LAN=LAN_PLUGIN_GALLERY_TITLE}</a></span></div>
<div id ="portfolio-gallery">
  <div class="row">
';
$GALLERY_TEMPLATE['portfolio']['item'] = '
    <div class="col-lg-3 pb-3">
      <img src="{GALLERY_THUMB: w=1000&h=800&thumbsrc}" class="img-fluid" alt="{GALLERY_CAPTION=text}" />
    </div>
';
